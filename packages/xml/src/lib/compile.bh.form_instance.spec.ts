...
describe('BrightHouse TC103 Form Instance', () => {
  it.skip('compiles', async () => {
    ...
    //   input,
    //   options,
    //   'fixtures/fixture-1.tc103.no-attachments.FormInstance.xml.ejs'
    // );

    // expect(removeWhitespace(compiled[0])).toEqual(
    //   removeWhitespace(
    //     fs.readFileSync(
    //       './packages/xml/fixtures/fixture-1.tc103.no-attachments.FormInstance.xml',
    //       'utf-8'
    //     )
    //   )
    // );
