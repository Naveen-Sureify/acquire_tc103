...
describe('BrightHouse TC103 137-145', () => {
  it.skip('compiles', async () => {
    ...
    const compiled = await compile(
      input,
      options,
      'fixtures/fixture-1.tc103.no-attachments.137-145.xml.ejs'
    );

    // expect(removeWhitespace(compiled[0])).toEqual(
    //   removeWhitespace(
    //     fs.readFileSync(
    //       './packages/xml/fixtures/fixture-1.tc103.no-attachments.137-145.xml',
    //       'utf-8'
    //     )
    //   )
    // );
