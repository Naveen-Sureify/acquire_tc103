...
describe('BrightHouse TC103 146-152', () => {
  it.skip('compiles', async () => {
    ...
    const compiled = await compile(
      input,
      options,
      'fixtures/fixture-1.tc103.no-attachments.146-152.xml.ejs'
    );

    // expect(removeWhitespace(compiled[0])).toEqual(
    //   removeWhitespace(
    //     fs.readFileSync(
    //       './packages/xml/fixtures/fixture-1.tc103.no-attachments.146-152.xml',
    //       'utf-8'
    //     )
    //   )
    // );
