...
describe('BrightHouse TC103 128-137', () => {
  it.skip('compiles', async () => {
    ...
    const compiled = await compile(
      input,
      options,
      'fixtures/fixture-1.tc103.no-attachments.128-137.xml.ejs'
    );

    // expect(removeWhitespace(compiled[0])).toEqual(
    //   removeWhitespace(
    //     fs.readFileSync(
    //       './packages/xml/fixtures/fixture-1.tc103.no-attachments.128-137.xml',
    //       'utf-8'
    //     )
    //   )
    // );
