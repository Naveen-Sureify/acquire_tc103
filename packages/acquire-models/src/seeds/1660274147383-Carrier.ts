/* eslint-disable */
// import { Carrier, CreateCarrierDto } from "@sureifylabs/acquire-models";
...
export class Client1660273378254 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        INSERT INTO acquire.carriers (
          carrier_config,
          title,
          access_code,
          phoneno,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DELETE FROM carriers WHERE id = 1;`);
  }
}
